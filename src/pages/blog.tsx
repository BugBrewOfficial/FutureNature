  ...
  const products = [
    {
      id: 1,
      name: 'GINGER HONEY',
      description: 'This blend is perfect for soothing sore throats, improving digestion, and warming the body, especially during chilly mornings or after meals. The bold combination of ginger and raw honey provides an energizing start to the day, making it an ideal choice for anyone seeking a natural boost.',
    ...
    },
    {
      id: 4,
      name: 'LEMON HONEY',
      description: 'Combining the freshness of lemon with the richness of raw honey, this blend is perfect for boosting immunity and providing natural energy. Great for adding to warm water in the morning or mixing with herbal teas for a citrus twist.',
    ...
    },
    {
      id: 5,
      name: 'TURMERIC HONEY',
      description: 'Known for its anti-inflammatory properties, turmeric honey is perfect for joint health and overall wellness. A perfect natural remedy for daily use and supporting your body\'s natural defense system.',
    ...
    },
    {
      ...
      description: 'Enriched with black seeds, this honey blend supports respiratory health and boosts immunity. Perfect for those seeking powerful natural wellness support with traditional herbs.',
    ...
    },
    {
      id: 7,
      name: 'CINNAMON HONEY',
      description: 'Warm and aromatic, cinnamon honey helps with blood sugar balance and adds a delightful spice to your daily wellness routine. Ideal for morning beverages or natural energy boosting.',
      image: '/Assets/Tile/T1.jpg',
      position: 'right'
    },
    {
      ...
      description: 'A powerful adaptogenic blend that helps manage stress and promotes mental clarity. Perfect for evening routines or whenever you need natural balance and calm.',
      image: '/Assets/Tile/T2.jpg',
      position: 'left'
    },
    {
    ...
    },
    {
      ...
      description: 'A blend of multiple flower nectars, this honey offers diverse nutritional benefits. Perfect for those who want comprehensive wellness support from nature\'s bounty.',
      image: '/Assets/Tile/T4.jpg',
      position: 'left'
    },
    {
    ...
    },
    {
      id: 14,
      name: 'BRAHMI HONEY',
      description: 'An ancient herb combined with honey for enhanced cognitive function and mental clarity. Perfect for students and professionals seeking natural mental support.',
      image: '/Assets/Tile/T2.jpg',
      position: 'left'
    },
    {
        ...
        <div style={{
          ...
          <div style={{
            ...
            <button
              ...
              onMouseLeave={(e) => {
                e.currentTarget.style.backgroundColor = 'rgba(251, 191, 36, 0.8)';
              }}
            >
