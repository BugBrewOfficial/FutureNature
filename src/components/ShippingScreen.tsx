...
const ShippingScreen: React.FC<ShippingScreenProps> = ({ onContinue, onClose }) => {
  ...
  const [selectedAddress, setSelectedAddress] = useState<AddressData | undefined>(undefined);
      ...
      <div style={{
        ...
        {loading ? (
          ...
          <>
            {addresses.length === 0 ? (
              <div style={{ textAlign: "center", padding: "40px" }}>
                <p style={{ color: "#6b7280", marginBottom: "20px" }}>No saved addresses found.</p>
                <button
                  onClick={() => { setView('add'); setEditingAddress(undefined); }}
                  style={{
              ...
              <AddressList
                addresses={addresses}
                onEdit={(addr) => { setEditingAddress(addr); setView('edit'); }}
                onDelete={handleDelete}
                onAddNew={() => { setEditingAddress(undefined); setView('add'); }}
          ...
          <div style={{ maxWidth: '600px', margin: '0 auto' }}>
            <AddressForm
              ...
              onCancel={() => { setView('list'); setEditingAddress(undefined); }}
            />
          </div>
        )}
      </div>
